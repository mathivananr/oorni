...
<div class="col-sm-10">
	...
	<div class="row">
		...
		<div class="col-lg-10 col-md-10 col-xm-12 col-sm-12">
		  <div class="row">
		    ...
		    <div class="col-lg-4 col-md-4 col-xm-4 col-sm-4">
		      <div class="well">
		        <h4 class="text-danger"><span class="label label-danger pull-right">${payout}</span> Payout </h4>
		      </div>
		    </div>
		  </div><!--/row-->    
		</div><!--/col-12-->
	...
	<div id="actions" class="btn-group">
        <a class="btn btn-primary" href="<c:url value='/admin/reportform?from=list'/>">
   ...
   <%--  <div id="actions" class="btn-group">
    ...
    <display:table name="report" cellspacing="0" cellpadding="0" requestURI=""
        ...
        <display:column property="reportId" escapeXml="true" sortable="true" titleKey="report.reportId" style="width: 25%"
                        url="/admin/reportform?from=list" paramId="id" paramProperty="reportId"/>
